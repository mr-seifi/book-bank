...
TELEGRAM_MESSAGES = {
    ...
    'help': 'اگه هنوز نمیدونی چطوری باید از بات استفاده کنی اینو ببین! \U0001F972',
    'first_help': 'برای آشنایی بیشتر با بات، این ویدیو رو ببین!',
    'cannot_find': 'کتابی که می‌خواستی پیدا نشد :('
}
